...
import javax.servlet.http.HttpServletResponse;
	...
	public class ListPersona03 extends HttpServlet{
		@Override
		protected void doGet(HttpServletRequest req, HttpServletResponse resp)
			...
			final Query q = pm.newQuery(Persona03.class);
			...
			if( req.getParameter("color")!=null ){
				...
				try{
					...
					List<Persona03> personas = (List<Persona03>) q.execute(color);
				...
				try{
					@SuppressWarnings("unchecked")
					List<Persona03> personas = (List<Persona03>) q.execute();
					req.setAttribute("personas", personas);
					RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/listpersona03.jsp");
					rd.forward(req, resp);
				}catch(Exception e){
