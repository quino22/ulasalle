...
<ul class="navbar">
  ...
  <li><a href="/listcolor">Lista</a>
</ul>

    
<form action="savecolor" method="get">
<fieldset><legend>Registro de color</legend>
<div id="formulario">
	<div class="fila">
		<div class="etiqueta"><label for="name">Nombre :</label></div>
		<div class="control"><input type="text" name="name" maxlength="10" value="" /></div>
	</div>
	
	<div class="fila">
		<div class="etiqueta"><label for="email">Email :</label></div>
		<div class="control"><input type="text" name="email" maxlength="50" value="" /></div>
	</div>
