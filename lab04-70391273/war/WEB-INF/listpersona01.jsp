...
<ul class="navbar">
  ...
  <li><a href="/persona01.jsp">Registro</a>
</ul>
<%
List<Persona01> personas = (List<Persona01>) request.getAttribute("personas");
%>
<div class="Table">
...
<%for( Persona01 p : personas ) {%>
	<div class="Row">
		...
		<%= "<div class=\"Cell\" style=\"background-color: "+p.getColor()+";\"><p>"+p.getColor()+"</p></div>" %>
	</div>
<%}%>
</div>
</body>
