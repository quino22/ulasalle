...
<ul class="navbar">
  ...
  <li><a href="/persona02">Registro</a>
</ul>
<%
List<Persona02> personas = (List<Persona02>)request.getAttribute("personas");
%>
<div class="Table">
...
<% for( Persona02 p : personas ) { %>	
	<div class="Row">
		...
		<%="<div class=\"Cell\" style=\"background-color: "+p.cualEsElColor()+";\"><p>"+p.cualEsElColor()+"</p></div>"%>
	</div>
<% } %>
</div>
</body>
